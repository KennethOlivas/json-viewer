      ...
      <div className="rounded border p-6">
        ...
        <div className="grid gap-6">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <div className="rounded border p-3">
              <div className="mb-2 text-xs text-muted-foreground">Secondary</div>
          ...
          <div>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <Textarea className="md:col-span-2" placeholder="Textarea example" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="switch-demo" className="text-sm text-muted-foreground">Switch</label>
              </div>
              <div className="w-48">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Tabs defaultValue="account">
              ...
              <TabsContent value="account" className="rounded border p-4 text-sm text-muted-foreground">
                Account content goes here.
              </TabsContent>
              <TabsContent value="profile" className="rounded border p-4 text-sm text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">This is a simple card using theme tokens.</p>
          ...
          <Alert>
            ...
            <AlertDescription>This is an alert demonstrating contrast and background.</AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="glass-panel rounded p-4">
              ...
              <p className="text-sm text-muted-foreground">This panel uses the glass styles and should adapt across themes.</p>
            </div>
            <div>
              <MonacoEditorClient height="240px" value={`{\n  \"preview\": true,\n  \"theme\": \"adaptive\"\n}`} />
            </div>
          </div>
        </div>
      </div>
